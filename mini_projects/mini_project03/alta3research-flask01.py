#!/usr/bin/python3 
"""This file will demonstrate proficiency with flask library using two endpoints"""
...
@app.route("/marvel/character/<character>", methods = ["GET"])
def main(character):
    ...
    result = marvelcharcall(rand, keyhash, pubkey, character)  # search for Wolverine   
    # return the results
    return result
