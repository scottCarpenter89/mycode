...
def main(): 
    ...
    while grappling_match:
        try:
            ...
            position = input("\nWhat BJJ defensive position would you like advice on from the list above? ")
            position_case_immune = position.lower()
            if defense.get(position_case_immune):
        ...
        while continue_advice:
            try: 
                ask_again = input("\nWould you like to hear advice on anything else?\n")
